...
const twitterCall = async () => {
    ...
    const response = await fetch(`https://api.twitter.com/2/tweets/search/recent?query=from:twitterdev`, {
        ...
        headers: {
            ...
            'Authorization': `Bearer AAAAAAAAAAAAAAAAAAAAAIEVjwEAAAAAwk1Gj%2FzlTgDFJGFqzbzknyH3TbA%3DR4c8DVqtxhGUwakpYmtUscfUoYUEIHEW3CVcgtOfCSDHKnEozr`
          },
    })
